 ...
 * 
 * 
 * @Configuration public class WebMvcConfig1 {
 * 
 ...
 * registrationBean.addUrlPatterns( "/student/*", "/book/*", "/bookcategory/*",
 * "/bookissue", "/bookfine/*", "/bookMaster/*", "/racks/*", "/requirement/*",
 * "/staff/*", "/attendance/*" ); registrationBean.setOrder(1); return
 * registrationBean; }
 * 
 * @Bean public FilterRegistrationBean<TokenFilter>
 * authFilterRegistrationBean(TokenFilter tokenFilter) {
 * FilterRegistrationBean<TokenFilter> registrationBean = new
 * FilterRegistrationBean<>(); registrationBean.setFilter(tokenFilter);
